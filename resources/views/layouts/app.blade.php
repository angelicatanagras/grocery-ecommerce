...
<title>Grocery Items | Dashboard</title>
<head>
    ...
    <link rel="stylesheet"
          href="{{asset('app-assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset('app-assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
    <!-- JQVMap -->
    <link rel="stylesheet" href="{{asset('app-assets/plugins/jqvmap/jqvmap.min.css')}}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{asset('app-assets/dist/css/adminlte.min.css')}}">
    <link rel="stylesheet" href="{{asset('app-assets/dist/css/styles.css')}}">
    <!-- overlayScrollbars -->
...
<!-- ChartJS -->
<script src="{{asset('app-assets/plugins/chart.js/Chart.min.js')}}"></script>
<!-- Sparkline -->
<script src="{{asset('app-assets/plugins/sparklines/sparkline.js')}}"></script>
<!-- JQVMap -->
<script src="{{asset('app-assets/plugins/jqvmap/jquery.vmap.min.js')}}"></script>
<script src="{{asset('app-assets/plugins/jqvmap/maps/jquery.vmap.usa.js')}}"></script>
<!-- jQuery Knob Chart -->
<script src="{{asset('app-assets/plugins/jquery-knob/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
<script src="{{asset('app-assets/plugins/moment/moment.min.js')}}"></script>
<script src="{{asset('app-assets/plugins/daterangepicker/daterangepicker.js')}}"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{asset('app-assets/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')}}"></script>
<!-- Summernote -->
